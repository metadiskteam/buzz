		...
		>
			...
			<div class="uploader-file-info">
				<div class="uploader-file-name">
					<i class="uploader-file-icon" :icon="fileCategory"></i>{{ file.name }}
				</div>
				<div class="uploader-file-size">{{ formatedSize }}</div>
				<div class="uploader-file-meta"></div>
				<div class="uploader-file-status">
					<span v-if="false" v-show="status !== 'uploading'">{{
						statusText
					}}</span>
				...
				<div class="uploader-file-actions">
					...
					<span v-if="false" class="uploader-file-resume" @click="resume"
						>️</span
					>
					<span v-if="false" class="uploader-file-retry" @click="retry"></span>
					<span
						v-if="false"
